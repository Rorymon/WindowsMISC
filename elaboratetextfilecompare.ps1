...
.SYNOPSIS
    .
.DESCRIPTION
    Compared the contents of two text files line by line and highlights the lines that are different. Created by Rory Monaghan. 
.PARAMETER $objFilePath1
    Path to a text file
.PARAMETER $objFilePath2
    Path to a text file
#>
...
cls
$objFile1 = Get-Content $objFilePath1
$objFile2 = Get-Content $objFilePath2
